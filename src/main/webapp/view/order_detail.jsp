        ...
        <div class="container" style="min-height: 100vh; margin-top: 180px;">
            ...
            <div class="row">
                <div class="rounded p-4 text-dark" style="min-height: 100px; background-color: #DFEBFF;">
                    <div class="row">
                        ...
                        <div class="col-4" style="font-size: larger;">
                            <span><strong>Người nhận vận chuyển: </strong></span>
                            <span><a href="profile.jsp">NguyenDong</a></span>
                        </div>
                        <div class="col-5" style="font-size: larger;">
                            <span><strong>Người nhận đơn: </strong></span>
                            <span>Neymar</span>
                        </div>
                    </div>
                    <div class="row py-3">
                        <div class="col-3" style="font-size: larger;">
                            <span><strong>Khổi lượng (gram): </strong></span>
                            <span>359</span>
                        </div>
                        <div class="col-4" style="font-size: larger;">
                            <span><strong>Số điện thoại: </strong></span>
                            <span>0987822857</span>
                        </div>
                        <div class="col-5" style="font-size: larger;">
                            <span><strong>Địa chỉ: </strong></span>
                            <span>K356/28 Mỹ An, Ngũ Hành Sơn, Đà Nẵng</span>
                        </div>
                    </div>
                ...
                <div class="row my-3">    
                    ...
                    <textarea class="form-control text-dark my-2" style="background-color: #EBECED; font-size: larger;" disabled id="message-text"  placeholder="Ghi chú trống..." rows="3">Chú gửi cho cháu cái điện thoại iphone14</textarea>
                </div>
                ...
                <div class="row my-3">
                    <div class="col-12 p-2" style="border-bottom: 1px solid #000;">
                        ...
                        <div class="modal fade" id="exampleModal-send" tabindex="-1" aria-labelledby="exampleModalLabel-send" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form>
                                            ...
                                            <div class="mb-3">
                                                <label for="message-text" class="col-form-label">Nhập địa chỉ hàng bắt đầu đi</label>
                                                <textarea class="form-control" id="message-text" placeholder="Nhập địa chỉ hàng bắt đầu đi..." rows="5"></textarea>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-primary" data-bs-dismiss="modal" style="width: 80px;">Huỷ</button>
                                                <button type="reset" class="btn btn-success" style="width: 100px;">OK</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                          ...
                          <div class="modal fade" id="exampleModal-success" tabindex="-1" aria-labelledby="exampleModalLabel-success" aria-hidden="true">
                            <div class="modal-dialog"  style="min-width: 1200px; ">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        <form>
                                            <div class="mb-3">
                                                <div class="rating-box">
                                                    <h4 class="text-center">Chắc chắn thành công? Thao tác này không thể chỉnh sửa được</h4>
                                                  </div>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-primary" data-bs-dismiss="modal" style="width: 80px;">Huỷ</button>
                                                <button type="reset" class="btn btn-success" style="width: 100px;">Xác nhận</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form>
                                            ...
                                            <div class="mb-3">
                                                <label for="message-text" class="col-form-label">Nhập địa chỉ hàng đã đến</label>
                                                <textarea class="form-control" id="message-text" placeholder="Nhập địa chỉ..." rows="5"></textarea>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-primary" data-bs-dismiss="modal" style="width: 80px;">Huỷ</button>
                    ...
                    <ul class="list-group mt-3">
                        <li class="list-group-item list-group-item-secondary">15/07/2023 16:00 Phát thành công (K356/28 Mỹ An, Ngũ Hành Sơn, Đà Nẵng)</li>
                      
                      
                        <li class="list-group-item list-group-item-primary">13/07/2023 16:00 Đã đến địa điểm (K356/28 Mỹ An, Ngũ Hành Sơn, Đà Nẵng)</li>
                        <li class="list-group-item list-group-item-primary">12/07/2023 16:00 Đã đến địa điểm (K356/28 Mỹ An, Ngũ Hành Sơn, Đà Nẵng)</li>
                        <li class="list-group-item list-group-item-primary">11/07/2023 16:00 Đã đến địa điểm (K356/28 Mỹ An, Ngũ Hành Sơn, Đà Nẵng)</li>
                        <li class="list-group-item list-group-item-info">10/07/2023 16:00 Bắt đầu gửi (K356/28 Mỹ An, Ngũ Hành Sơn, Đà Nẵng)</li>
                      </ul>
                </div>
            </div>
        </div>
