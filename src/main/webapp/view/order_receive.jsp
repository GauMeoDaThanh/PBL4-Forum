                ...
                <nav class="navbar navbar-dark navbar-expand-lg py-0">
                    ...
                    <div class="collapse navbar-collapse bg-transparent" id="navbarCollapse">
                        <div class="navbar-nav ms-auto mx-xl-auto p-0">
                            <a href="./order_receive.html" class="nav-item nav-link active">Đơn nhận</a>
                      ...
                      <table class="table table-bordered">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td><a href=""><img src="${pageContext.request.contextPath}/assets/img/101.jpg" alt="mdo" width="35" height="35" class="rounded-circle" style="margin-right: 3px;">Recoon</a></td>
