            ...
            <div class="container">
                <div class="row rounded border mt-3" style="min-height: 300px;">
                    <div class="col-2 p-2 text-center" style="background-color: #E5F2FF; border-right: 1px solid #d3d5d7;">
                        <img src="${pageContext.request.contextPath}/assets/img/101.jpg"  class="rounded-circle mr-1 avatar-hover" alt="Vanessa Tucker" width="100" height="100">
                        <div>
                ...
                <div class="row rounded border mt-2" style="height: 200px;"></div>
                <div class="row rounded border mt-2" style="min-height: 300px;">
                    <div class="col-2 p-2 text-center" style="background-color: #E5F2FF; border-right: 1px solid #d3d5d7;">
                        <img src="${pageContext.request.contextPath}/assets/img/101.jpg"  class="rounded-circle mr-1 avatar-hover" alt="Vanessa Tucker" width="100" height="100">
                        <div>
                            <a class="text-primary my-2" href="" style="font-weight: 700; font-size: larger;">Leo Messi</a>
                    ...
                    <div class="col-10 p-3" style="background-color: #E5F2FF; ">
                        <p style="border-bottom: 1px solid #d3d5d7; min-height: 80%;">Diễn đàn VOZ vừa được cập nhật lên phiên bản hơi mới, với những thay đổi tập trung chính về hiệu năng và nâng cao trải nghiệm. Một vài ví dụ:
                            ...
                            Thông báo có thể đánh dấu đã đọc từng cái một, có thể tinh chỉnh tự động đánh dấu, tổng hợp... abcxyz... ai rảnh thì mò thử.
                            App của VOZ tự login, update thông báo kịp thời hơn... nhưng có quảng cáo, app lậu thì không (nhưng dừng dùng app lậu, chúng nó cũng chèn quảng cáo ngoài vào thôi, mà giao diện thì xấu vãi chưởng)
                            4. Cơ hội và nhận định:

                                + Kiên nhẫn chờ đợi các nhịp điều chỉnh của thị trường chung để mua vào các cổ phiếu tốt có định giá rẻ và nắm giữ lâu dài cho chu kỳ tăng giá tiếp theo.

                                + Phương pháp tích sản cổ phiếu phù hợp với giai đoạn thị trường này, mua vào đều đặn hàng tháng.

                                + Ưu tiên chọn cổ phiếu có nền tảng cơ bản tốt, vay nợ ít, có định giá hợp lý, tránh việc ham các cổ phiếu giá rẻ, cổ phiếu rác và các cổ phiếu có nền tảng cơ bản kém, vay nợ lớn.
                                Diễn đàn VOZ vừa được cập nhật lên phiên bản hơi mới, với những thay đổi tập trung chính về hiệu năng và nâng cao trải nghiệm. Một vài ví dụ: Nhanh cực, nếu thấy chậm thì refresh lại thử xem sao. Mã xác thực 2 lớp không phải nhập lại nếu bạn vào VOZ thường xuyên, ít vào thì chịu. Thông báo có thể đánh dấu đã đọc từng cái một, có thể tinh chỉnh tự động đánh dấu, tổng hợp... abcxyz... ai rảnh thì mò thử. App của VOZ tự login, update thông báo kịp thời hơn... nhưng có quảng cáo, app lậu thì không (nhưng dừng dùng app lậu, chúng nó cũng chèn quảng cáo ngoài vào thôi, mà giao diện thì xấu vãi chưởng) 4. Cơ hội và nhận định: + Kiên nhẫn chờ đợi các nhịp điều chỉnh của thị trường chung để mua vào các cổ phiếu tốt có định giá rẻ và nắm giữ lâu dài cho chu kỳ tăng giá tiếp theo. + Phương pháp tích sản cổ phiếu phù hợp với giai đoạn thị trường này, mua vào đều đặn hàng tháng. + Ưu tiên chọn cổ phiếu có nền tảng cơ bản tốt, vay nợ ít, có định giá hợp lý, tránh việc ham các cổ phiếu giá rẻ, cổ phiếu rác và các cổ phiếu có nền tảng cơ bản kém, vay nợ lớn.
                                Diễn đàn VOZ vừa được cập nhật lên phiên bản hơi mới, với những thay đổi tập trung chính về hiệu năng và nâng cao trải nghiệm. Một vài ví dụ: Nhanh cực, nếu thấy chậm thì refresh lại thử xem sao. Mã xác thực 2 lớp không phải nhập lại nếu bạn vào VOZ thường xuyên, ít vào thì chịu. Thông báo có thể đánh dấu đã đọc từng cái một, có thể tinh chỉnh tự động đánh dấu, tổng hợp... abcxyz... ai rảnh thì mò thử. App của VOZ tự login, update thông báo kịp thời hơn... nhưng có quảng cáo, app lậu thì không (nhưng dừng dùng app lậu, chúng nó cũng chèn quảng cáo ngoài vào thôi, mà giao diện thì xấu vãi chưởng) 4. Cơ hội và nhận định: + Kiên nhẫn chờ đợi các nhịp điều chỉnh của thị trường chung để mua vào các cổ phiếu tốt có định giá rẻ và nắm giữ lâu dài cho chu kỳ tăng giá tiếp theo. + Phương pháp tích sản cổ phiếu phù hợp với giai đoạn thị trường này, mua vào đều đặn hàng tháng. + Ưu tiên chọn cổ phiếu có nền tảng cơ bản tốt, vay nợ ít, có định giá hợp lý, tránh việc ham các cổ phiếu giá rẻ, cổ phiếu rác và các cổ phiếu có nền tảng cơ bản kém, vay nợ lớn.
                        </p>
                        <button class="icon-hover btn">
                            <i class="bi bi-heart" style="margin-left: 16px;"></i>
