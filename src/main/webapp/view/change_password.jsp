            ...
            <div class="container">
                <form action="" method="" class="p-4 rounded shadow" style="border: 10px solid #DFEBFF;">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control" id="password-account" placeholder="Nhập mật khẩu cũ">
                    </div>
                    <div class="mb-3">
                        <label for="new-password" class="form-label"><strong>Mật khẩu mới</strong></label>
                        <input type="password" class="form-control" id="new-password" value="" placeholder="Nhập mật khẩu mới">
                    </div>
                    <div class="mb-3">
                        <label for="new-password" class="form-label"><strong>Nhập lại mật khẩu mới</strong></label>
                        <input type="password" class="form-control" id="new-password" value="" placeholder="Nhập lại mật khẩu mới">
                    </div>
