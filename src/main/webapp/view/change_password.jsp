...
/assets/css/style.css">
    ...
    <body>
        ...
        <main class="content" style="margin-top: 150px; margin-bottom: 150px;">
            <div class="container">
                <form id="form-password" action="../Profile/UpdatePassword" method="post" class="p-4 rounded shadow" style="border: 10px solid #DFEBFF;" oninput="re_new_password.setCustomValidity(re_new_password.value !== new_password.value ? 'Mật khẩu không giống' : '')">
                    <div class="mb-5">
                        <h1 class="text-center">Đổi mật khẩu</h1>
                    </div>
                    <div class="mb-3">
                        <label for="password-account" class="form-label"><strong>Mật khẩu hiện tại</strong></label>
                        <input type="password" class="form-control" id="password-account" placeholder="Nhập mật khẩu hiện tại" name="password" required>
                    </div>
                    <div class="mb-3">
                        <label for="new-password" class="form-label"><strong>Mật khẩu mới</strong></label>
                        <input type="password" class="form-control" id="new-password" value="" placeholder="Nhập mật khẩu mới" name="new_password" required>
                    </div>
                    <div class="mb-3">
                        <label for="new-password" class="form-label"><strong>Nhập lại mật khẩu mới</strong></label>
                        <input type="password" class="form-control" id="re_new_password" value="" placeholder="Nhập lại mật khẩu mới" name="re_new_password" required>
                    </div>
                    <div class="text-center">
                        <button type="submit" class="btn btn-success px-4 py-2">Đổi mật khẩu</button>
                    </div>
                </form>
            </div>
        </main>
