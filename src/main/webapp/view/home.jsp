            ...
            <div class="container">
                <div class="row border-top">
                    <a href="${pageContext.request.contextPath}/Topic/Receive?pageIndex=1">
                        <h4 class="p-2 bg-primary text-secondary border-top underline-hover" style="display: block;">BÀI NHẬN VẬN CHUYỂN</h4>
                    </a>
                </div>
                <%
            ...
            <div class="container py-5">
                <div class="row border-top">
                    <a href="${pageContext.request.contextPath}/Topic/Send?pageIndex=1">
                        <h4 class="p-2 bg-primary text-secondary border-top underline-hover" style="display: block;">BÀI GỬI VẬN CHUYỂN</h4>
                    </a>
                </div>
                <%
