...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="${pageContext.request.contextPath}/assets/library/fontawesome-free-6.4.2-web/css/all.css"
    />
    <link
      rel="stylesheet"
      href="${pageContext.request.contextPath}/assets/library/bootstrap-icons-1.11.1/bootstrap-icons.css"
    />
        ...
        <div class="d-flex justify-content-between topbar">
          <div class="top-info">
            <small class="me-3 text-white-50"
              ...
              >54 Nguyễn Lương Bằng, Đà Nẵng</small
            >
            <small class="me-3 text-white-50"
              ><a href="#"
                ><i class="fas fa-envelope me-2 text-secondary"></i></a
              >PBL4@gmail.com</small
            >
          </div>
          <div id="note" class="text-secondary d-none d-xl-flex">
            <small>Đến với chúng tôi, mọi thứ rất dễ dàng</small>
          </div>
          <div class="top-link">
            <a
              href=""
        ...
        <nav class="navbar navbar-dark navbar-expand-lg py-0">
          <a href="index.html" class="navbar-brand">
            <h1 class="text-white fw-bold d-block">
              Trans<span class="text-secondary">Port</span>
            </h1>
          </a>
          <button
            type="button"
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="LoginLabel" style="display: block">
                Đăng nhập
              </h5>
              <h5 class="modal-title" id="RegisterLabel" style="display: none">
                Đăng ký
              </h5>
              <button
                type="button"
            ...
            <div class="modal-body">
              <form action="" id="form-login" style="display: block">
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  >
                  <a href="#" id="register-tab" onclick="ClickRegisterTab()"
                    >Đăng ký</a
                  >
                </div>
              ...
              <form action="" id="form-register" style="display: none">
                <div class="mb-3">
                  <label for="recipient-name" class="col-form-label"
                    >Tên đăng nhập</label
                  >
                ...
                <div class="mb-3">
                  ...
                  >
                  <a href="#" id="login-tab" onclick="ClickLoginTab()"
                    >Đăng nhập</a
                  >
                </div>
            ...
            <div class="carousel-caption">
              <div class="container carousel-content">
                ...
                <p class="mb-4 text-white fs-5 animated fadeInDown">
                  Chúng tôi làm diễn đàn này đem đến giải pháp cho mọi người
                  trong việc vận chuyển hàng hoá.
                </p>
                <!-- <a href="" class="me-2"
                  ><button
                    type="button"
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-caption">
              <div class="container carousel-content">
                ...
                <p class="mb-4 text-white fs-5 animated fadeInDown">
                  Chúng tôi sẵn lòng lắng nghe ý kiến của mọi người. Làm mọi thứ
                  tốt nhất có thể, đem đến trải nghiệm tốt nhất cho người dùng
                </p>
                <!-- <a href="" class="me-2"
                  ><button
                    type="button"
        ...
        <div class="row g-5">
          <div class="col-lg-3 col-md-6">
            ...
            <p class="mt-4 text-light">
              Chúng tôi tạo ra diễn đàn này giúp mọi người kết nối và dễ dàng
              vận chuyển.
            </p>
          ...
          <div class="col-lg-3 col-md-6">
            ...
            <div class="mt-4 d-flex flex-column short-link">
              <a href="" class="mb-2 text-white"
                ><i class="fas fa-angle-right text-secondary me-2"></i>Về chúng
                tôi</a
              >
              <a href="" class="mb-2 text-white"
                ><i class="fas fa-angle-right text-secondary me-2"></i>Liên
                lạc</a
              >
              <a href="" class="mb-2 text-white"
                ><i class="fas fa-angle-right text-secondary me-2"></i>Dịch
                vụ</a
              >
              <a href="" class="mb-2 text-white"
                ><i class="fas fa-angle-right text-secondary me-2"></i>Dự án</a
              >
              <a href="" class="mb-2 text-white"
                ><i class="fas fa-angle-right text-secondary me-2"></i>Khác</a
              >
            </div>
          </div>
          <div class="col-lg-3 col-md-6">
            ...
            <div class="mt-4 d-flex flex-column help-link">
              <a href="" class="mb-2 text-white"
                ><i class="fas fa-angle-right text-secondary me-2"></i>Điều
                khoản sử dụng</a
              >
              <a href="" class="mb-2 text-white"
                ><i class="fas fa-angle-right text-secondary me-2"></i>Chính
                sách riêng tư</a
              >
              <a href="" class="mb-2 text-white"
                ><i class="fas fa-angle-right text-secondary me-2"></i>Trợ
                giúp</a
              >
              <a href="" class="mb-2 text-white"
                ><i class="fas fa-angle-right text-secondary me-2"></i>Hỏi
                đáp</a
              >
              <a href="" class="mb-2 text-white"
                ><i class="fas fa-angle-right text-secondary me-2"></i>Tính năng
                mới</a
              >
            </div>
          </div>
          <div class="col-lg-3 col-md-6">
            ...
            <div class="text-white mt-4 d-flex flex-column contact-link">
              <a href="#" class="pb-3 text-light border-bottom border-primary"
                ><i class="fas fa-map-marker-alt text-secondary me-2"></i>54
                Nguyễn Lương Bằng</a
              >
          ...
          <div class="col-md-6 text-center text-md-start">
            <span class="text-light"
              ><a href="#" class="text-secondary"
                ...
                >Transport</a
              >, Mọi bản quyền liên hệ chúng tôi.</span
            >
          </div>
          <div class="col-md-6 text-center text-md-end">
            <span class="text-light"
              >Thiết kế bởi<a href="" class="text-secondary">
                Nguyễn Đông và Văn Đạt</a
              >
