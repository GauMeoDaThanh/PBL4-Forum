                    ...
                    <div class="d-flex">
                        <div class="w-100 d-flex" style="background-color: #E5F2FF;">
                            ...
                            <div class="p-4">
                                <div>
                                    <h3>NguyenDong</h3>
                                    <span style="font-size: large;">Nhà vô địch thế giới.Nhà vô địch thế giới.Nhà vô địch thế giới.Nhà vô địch thế giới.Nhà vô địch thế giới.Nhà vô địch thế giới.Nhà vô địch thế giới.Nhà vô địch thế giới.Nhà vô địch thế giới.Nhà vô địch thế giới.Nhà vô địch thế giới.Nhà vô địch thế giới.</span><br><br>
                                    ...
                                    <span style="font-size: large;"><strong>Số sao đánh giá trung bình: </strong>5.0<i class="fas fa-star" style="color: rgb(255, 213, 0);"></i></span>
                                </div>
                                <div class="my-4">
                                    <button class="btn btn-primary mx-4" style="width: 100px;">Báo cáo</button>
                ...
                <div class="row p-3">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation" style="background-color: #E5F2FF;">
                          <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Bài viết đã đăng</button>
                        </li>
                        <li class="nav-item" role="presentation" style="background-color: #E5F2FF;">
                                ...
                                <div class="card-body">
                                    <div class="d-flex">
                                        ...
                                        <div class="media-body mx-2" style="min-width: 60%; max-width: 60%;">
                                            <span class="text-white rounded p-1" style="background-color: #A231FC;">Bài nhận vận chuyển</span>
                                            <h4 class="mt-2"><a href="post_detail.jsp" data-toggle="collapse" data-target=".forum-content" class="text-body"><strong>Nhận vận chuyển nội thành Đà Nẵng.Nhận vận chuyển nội thành Đà Nẵng</strong></a></h4>
                            ...
                            <div class="card mb-2" style="background-color: #E5F2FF;">
                                <div class="card-body">
                                    <div class="d-flex">
                                        <a href="" data-toggle="collapse" data-target=".forum-content"><img src="../assets/img/29.jpg" class="mr-3 rounded-circle" width="70" height="70" alt="User" /></a>
                                        <div class="media-body mx-2" style="min-width: 60%; max-width: 60%;">
                                            <span class="text-white rounded p-1" style="background-color: #7752FE;">Bài gửi vận chuyển</span>
                                            <h4 class="mt-2"><a href="post_detail.jsp" data-toggle="collapse" data-target=".forum-content" class="text-body"><strong>Nhận vận chuyển nội thành Đà Nẵng.Nhận vận chuyển nội thành Đà Nẵng</strong></a></h4>
                                            <p class="text-muted"><a href="javascript:void(0)">NguyenDong</a> at <span class="text-dark font-weight-bold">05/05/2023 16:00</span></p>
                                        </div>
                                        <div class="media-body mx-4" style="width: 20%;">
